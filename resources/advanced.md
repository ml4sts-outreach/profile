...
[sphinx](https://www.sphinx-doc.org/en/master/index.html) and it is called by a GitHub action to build. You edit markdown, it converts to HTML and hosts. 
...
The shorturls eg `drsmb.co/nsbe50` are hosted in a [repo, drsmb-co.github.io](https://github.com/drsmb-co/drsmb-co.github.io) that is linked to my custom domain `drsmb.co`.  It builds from a yaml file to the html site using a package [urlfwd](https://github.com/brownsarahm/urlfwd) that I made, called by a GitHub action, similar to the one that builds your site. 